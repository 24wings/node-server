...
var base64 = fs.readFileSync(path.resolve(__dirname, "../public/webp.webp"), { encoding: "base64" });
// console.log(base64);

var CWebp = require('cwebp').CWebp;
var DWebp = require('cwebp').DWebp;

// var encoder = new CWebp(path.resolve(__dirname,"../public/webp.webp"));
// var decoder = new DWebp(fs.readFileSync(path.resolve(__dirname, "../public/webp.webp")));
// console.log(decoder);

// decoder.toBuffer(function (err, buffer: Buffer) {
